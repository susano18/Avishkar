...
async def list_documents(
    ...
    # Fetch page
    # Optimization: Select columns explicitly and calculate text length via func.length
    # to avoid loading the massive extracted_text column into memory.
    ...
    # Map database rows to DocumentResponse schemas
    documents = []
    for row in rows:
        documents.append(
            DocumentResponse(
                ...
                extracted_text=None,  # Not loaded for list view
