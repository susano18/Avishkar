...
async def list_documents(
    ...
    # Fetch page
    # Optimization: Use defer() to avoid loading the large extracted_text blob from DB.
    # The DocumentSlimResponse schema and extracted_text_length property handle the metadata.
    ...
    return DocumentListResponse(
        documents=[DocumentSlimResponse.model_validate(d) for d in documents],
        total=total,
        page=page,
        page_size=page_size,
    )
