...
async def upload_document(
    ...
    # Validate file size (Sentinel enhancement: prevent large file DoS)
    ...
    try:
        ...
        # Secure error handling: log the detail but return a generic message
