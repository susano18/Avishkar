...
async def upload_document(
    ...
    # Validate file size
    # In FastAPI, we can try to get the size from the UploadFile object
    # or the underlying SpooledTemporaryFile.
    file_size = 0
    try:
        ...
        logger.warning("failed_to_get_file_size", error=str(e))
        # Fallback: some environments might not support seek(0, 2) on all file-like objects
        pass
