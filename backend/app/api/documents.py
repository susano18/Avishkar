...
async def list_documents(
    ...
    # Fetch page - Optimization: select specific columns and text length
    # to avoid transferring huge text blobs in list view.
    ...
    documents = [
        DocumentResponse(
            ...
            extracted_text=None,  # Omit from list view
