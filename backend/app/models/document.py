...
class Document(Base):
    ...
    # Optimization: Calculate text length on the database side to avoid loading
    # the full extracted_text blob in list views.
    extracted_text_length: Mapped[Optional[int]] = column_property(
