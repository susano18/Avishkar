...
class DocumentSlimResponse(BaseModel):
    """Schema for document metadata without the large text content."""
    ...
    extracted_text_length: int | None = Field(0, description="Length of the extracted text in characters.")
