...
class DocumentShortResponse(DocumentBaseResponse):
    """Schema for document listing (excludes large text content)."""

    extracted_text_length: int = Field(0, description="Length of the extracted text content.")


class DocumentResponse(DocumentBaseResponse):
    """Schema for full document details (includes text)."""
