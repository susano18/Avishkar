                  ...
                  <AlertDialog>
                    <AlertDialogTrigger asChild>
                      <button
                        ...
                        className="rounded p-1 text-muted-foreground opacity-0 transition-opacity group-hover:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-accent hover:bg-destructive/10 hover:text-destructive outline-none"
                      >
                        <Trash size={14} />
                      </button>
                    </AlertDialogTrigger>
