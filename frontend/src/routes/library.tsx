                  ...
                  <AlertDialog>
                    <AlertDialogTrigger asChild>
                      <button
                        ...
                        className="rounded p-1 text-muted-foreground opacity-0 transition-opacity group-hover:opacity-100 focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring hover:bg-destructive/10 hover:text-destructive"
                      >
                        <Trash size={14} />
                      </button>
                    </AlertDialogTrigger>
                    <AlertDialogContent onClick={(e) => e.stopPropagation()}>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          This will permanently delete this document and its extracted text. This
